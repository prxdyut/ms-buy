...
export async function sendMail(data) {
  try {
    let to = data.orderData.email,
      ...
      discount = data.orderSummary.promo.discount,
      promoCode = data.orderSummary.promo.code,
      subtotal = data.orderSummary.subtotal,
      shipping = data.orderSummary.shipping,
      total = data.orderSummary.total,
      shippingAddress =
        data.orderData.address1 +
        ", " +
        data.orderData.address2 +
        ", " +
        data.orderData.city +
        ", " +
        data.orderData.state +
        ", " +
        data.orderData.country +
        ", " +
        data.orderData.pincode,
      subject =
                    ...
                    <tr>
                      ...
                      >
                        ...
                        >
                          <a
                            href="${
                              "https://www.galaeyelashes.in/products/" +
                              order.slug
                            }"
                            target="_blank"
