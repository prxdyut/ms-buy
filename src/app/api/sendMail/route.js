...
export async function POST(req) {
  try {
    let to = "daspradyut516@gmail.com",
      fullName = "Pradyut Das",
      orderId = "2332rewd43refw",
      orderDate = "12-12-2023",
      orderData = [
        {
          image:
            "https://cdn.sanity.io/images/fteektnk/production/c9eb6cfb691ec13b7a1d3059fe6d3adce7b47b14-1080x1080.png",
          title: "Weightless Makeup Powder",
          quantity: 2,
          price: 200,
          category: "eyelash",
          slug: "weightless-makeup-powder",
        },
        {
          image:
            "https://cdn.sanity.io/images/fteektnk/production/d209cf0674bee4b3ea4fbbab64a706cf7f78c69e-1080x1080.png",
          title: "Pencil Eye Liner",
          quantity: 2,
          price: 700,
          category: "pencil",
      ...
      total = 400,
      shippingAddress =
        "Shop No 21-27, Kesar Residency, Sangh Chhaya CHS, RDP 8, Charkop Sector 3, Kandivali West, Mumbai, Maharashtra 400067",
      subject =
        "Order Confirmation Mail for #" + orderId + " on Galaeyelashes.in";
    ...
    const transporter = nodemailer.createTransport({
      ...
      debug: true,
      auth: {
        user: process.env.BUSINESS_MAIL_ADDRESS,
        pass: process.env.BUSINESS_MAIL_PASSWORD,
      },
    });
    const info = await transporter.sendMail({
      from: "business@galaeyelashes.in",
      to,
      subject,
      html: `<html>
                                                                  ...
                                                                  <tbody>
                                                                      <tr>
                                                                          <th class="column_logo"
                                                                              ...
                                                                              <!-- Logo : BEGIN -->
                                                                              <a href="https://www.galaeyelashes.in"
                                                                                  target="_blank"
                                                                  ...
                                                                  <tbody>
                                                                      ...
                                                                      <tr id="section-1468267" class="section introduction">
                                                                          <th style="mso-line-height-rule: exactly; padding: 13px 52px;"
                                                                              ...
                                                                              <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                                                                  align="center">Order Paid via Razorpay.</p>
                                                                              </p>
            ...
            >
              <tbody>
                <tr>
                  ...
                  >
                    <p
                      style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                      align="left"
                    >
                      <a
                        href="${
                          "https://www.galaeyelashes.in/products/" + order.slug
                        }"
                        target="_blank"
                                                                      ...
                                                                      <tr id="section-1468276" class="section closing_text">
                                                                          <th data-key="1468276_closing_text" class="text"
                                                                              ...
                                                                              <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                                  ...
                                                                                  email: business@galaeyelashes.in</p>
                                                                          </th>
                                                                      </tr>
                                                                                  ...
                                                                                  <tbody>
                                                                                      <tr>
                                                                                          <th class="menu_bar_item first"
                                                                                              ...
                                                                                              align="center"
                                                                                              bgcolor="#ffffff">
                                                                                              <a href="https://www.galaeyelashes.in/category"
                                                                                                  target="_blank"
                                                                                          ...
                                                                                          <th class="menu_bar_item"
                                                                                              ...
                                                                                              align="center"
                                                                                              bgcolor="#ffffff">
                                                                                              <a href="https://www.galaeyelashes.in/about"
                                                                                                  target="_blank"
                                                                                                  style="color: #bdbdbd; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: center !important; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; font-weight: 400; line-height: 26px; text-transform: uppercase; letter-spacing: 1px;">
                                                                                                  About Us
                                                                                              </a>
                                                                                          ...
                                                                                          <th class="menu_bar_item last"
                                                                                              ...
                                                                                              align="center"
                                                                                              bgcolor="#ffffff">
                                                                                              <a href="https://www.galaeyelashes.in/contact"
                                                                                                  target="_blank"
                                                                                                  style="color: #bdbdbd; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: center !important; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; font-weight: 400; line-height: 26px; text-transform: uppercase; letter-spacing: 1px;">
                                                                                                  Contact
                                                                                              </a>
                                                                                      ...
                                                                                      <tr>
                                                                                          <th class="column_shop_block1 "
                                                                                              ...
                                                                                              <a href="https://www.galaeyelashes.in/"
                                                                                                  ...
                                                                                                  style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">www.galaeyelashes.in</a>
                                                                                          </th>
                                                                                      </tr>
                                                                                      <!-- Store Website : END -->
                                                                                  </tbody>
